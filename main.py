...
async def broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not all_users:
        await update.message.reply_text("❌ डेटाबेस में कोई भी USER मौजूद नहीं है।")
        return
...
async def process_batch_queue(user_id, context: ContextTypes.DEFAULT_TYPE, message):
    ...
    if saved_files_meta:
        ...
        await status_msg.edit_text("❌ कोई मज़बूत फाइल प्रोसेस नहीं हो सकी।")
...
if __name__ == "__main__":
    # Pella Server के लिए एक्स्ट्रा लाइटवेट नेटवर्क पूल कनेक्शन सेट किया गया है
    app = (
        ApplicationBuilder()
    ...
    print("🤖 Bot is completely optimized for Pella Server loop setup!")
    
    # Pella Server के क्रैश होने से बचने के लिए drop_pending_updates चालू है
